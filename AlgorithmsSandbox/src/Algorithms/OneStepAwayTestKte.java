...
//        public static TestData constructATestCase (int length) {
//
//        }
    }
    ...
    private void testOnStaticExamples() {
        for (TestData testData: staticExamples) {
            ...
            assertTrue(OneStepAwayKte.isOneStepAway(testData.string1, testData.string2) == testData.result);
        }
    }
